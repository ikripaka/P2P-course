...
class CustomHashMapTest {
    private HashMap<String, Integer> original = new HashMap<>();
    private CustomHashMap<String, Integer> custom = new CustomHashMap<>();
    ...
    void put() {
        ...
        custom.put(null,null);
        System.out.println(custom.containsKey(null) + "  -  " + custom.containsValue(null));
    }
    ...
    @Test
    void contains() {
        System.out.println("Custom contains '1000 & ()' : " + custom.containsKey(1000 + " & ()"));
        System.out.println("Original contains '1000 & ()' : " + original.containsKey(1000 + " & ()"));
        System.out.println(custom.containsKey(1));
        System.out.println(original.containsKey(1));
        Assertions.assertSame(custom.containsKey(1000 + " & ()"), original.containsKey(1000 + " & ()"));
        Assertions.assertSame(custom.containsKey(1), original.containsKey(1));
    }
