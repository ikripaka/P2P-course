...
public class FallingBalls extends WindowProgram implements FallingBallsConstants {
    ...
    private void animateOneBall(int counter) {
        ...
        if ((ballBelowTheFloor(ballsArrayList.get(counter)) && ballsArrayList.get(counter).getDy() > 0) || (ballOverTheCeiling(ballsArrayList.get(counter))&& ballsArrayList.get(counter).getDy() < 0)) {
